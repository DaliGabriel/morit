<section
    class="relative h-72 bg-blue flex flex-col justify-center align-center text-center space-y-4 mb-10"
>
    <div
        class="absolute top-0 left-0 w-full h-full opacity-5 bg-no-repeat bg-center"
